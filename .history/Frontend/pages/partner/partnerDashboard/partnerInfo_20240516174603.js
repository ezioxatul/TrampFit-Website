    ...
    return (
        <>
            <div className="flex flex-col min-h-screen">
                <div className="flex">
                    <PartnerSideBar />
                    <div className={`${containerClassName} mt-12 ml-8`}>
                        <Avatar className="w-36 h-36 text-6xl bg-black" src="/avtar.png" />
                    </div>
                </div>
                <div>
                    <h1 className={`${containerClassName} text-xl mb-4`}>Personal Information</h1>
